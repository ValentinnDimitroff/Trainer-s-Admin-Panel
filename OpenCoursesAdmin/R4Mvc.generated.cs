...
{
    public static readonly OpenCoursesAdmin.Controllers.AccountController Account = new OpenCoursesAdmin.Controllers.R4MVC_AccountController();
    public static readonly OpenCoursesAdmin.Controllers.ConfigurationsController Configurations = new OpenCoursesAdmin.Controllers.R4MVC_ConfigurationsController();
    public static readonly OpenCoursesAdmin.Controllers.CourseController Course = new OpenCoursesAdmin.Controllers.R4MVC_CourseController();
    public static readonly OpenCoursesAdmin.Controllers.HomeController Home = new OpenCoursesAdmin.Controllers.R4MVC_HomeController();
    public static readonly OpenCoursesAdmin.Controllers.ManageController Manage = new OpenCoursesAdmin.Controllers.R4MVC_ManageController();
    public static readonly OpenCoursesAdmin.Controllers.QuizsController Quizs = new OpenCoursesAdmin.Controllers.R4MVC_QuizsController();
    public static readonly OpenCoursesAdmin.Controllers.SurveyController Survey = new OpenCoursesAdmin.Controllers.R4MVC_SurveyController();
    public static readonly OpenCoursesAdmin.Controllers.UploadProtocolsController UploadProtocols = new OpenCoursesAdmin.Controllers.R4MVC_UploadProtocolsController();
